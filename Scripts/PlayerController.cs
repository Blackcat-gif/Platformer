...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        _animator.SetBool("IsMoving", Mathf.Abs(_rigidBody.linearVelocity.x) > 0.2 || 
            Mathf.Abs(_rigidBody.linearVelocity.z) > 0.2);
        ...
        _rigidBody.linearVelocity = new Vector3(leftRight, _rigidBody.linearVelocity.y, upDown);
        // have player face direction of travel
        var facingDirection = _rigidBody.linearVelocity;
